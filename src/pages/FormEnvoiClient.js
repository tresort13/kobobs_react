...
<Form>
    ...
    <Row className='justify-content-center'>
        ...
        <Form.Control name="montant_envoie" value={props.envoie.infoEnvoie.montant_envoie} onChange={e=>inputChanged(e)} type="text" placeholder="Mbongo"  required/>
         </Form.Group>
        </Col>
        ...
        <Form.Select name="montant_device" value={props.envoie.infoEnvoie.montant_device} aria-label="Default select example" onChange={e=>inputChanged(e)} placeholder="Device" required>
         <option>GBP (£)</option>
