...
function HeaderHome(props)
{
    ...
    <Row>
        ...
        <Col xs={4} className="my-auto mx-auto text-end ">
         <div>
           <pre className="text-dark display-6" style={{fontSize: 20}}><Image className="navbar-brand rounded-circle" src={require('./login.jpeg')} type="button" alt="profil" style={{width:40}} ></Image><a href="" style={{textDecoration:"none"}}><span className="couleur2"><i>Bienvenu(e)</i></span></a></pre>
   ...
   {isMobileOrTablet && <Container className="pt-2 bg-dark" fluid >
    ...
    <Row className="mt-2">
        ...
        <Col xs={"auto"} className=" mx-auto my-auto text-end">
         <div>
           <pre className="text-dark display-6 text-end" style={{fontSize: 20}}><a href="" style={{textDecoration:"none"}}><span className="couleur2"><i onClick={logout}> Bienvenu(e)</i></span></a></pre>
